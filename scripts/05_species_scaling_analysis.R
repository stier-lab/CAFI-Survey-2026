...
if (nrow(scaling_data) >= 30) {
  ...
  # --------------------------------------------------------------------------
  # DESIGN: Site colors from global SITE_COLORS (00_setup.R)
  # --------------------------------------------------------------------------
  ...
  # Uses all_results_df already in memory from this script
  # --------------------------------------------------------------------------
  species_scaling <- all_results_df %>%
