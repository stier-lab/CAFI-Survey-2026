...
output/
├── figures/
│   ├── manuscript/          # 5 main text figures + 1 legend file
...
│   │   ├── fig3_functional_groups.png  (from 08_functional_groups.R)
│   │   ├── fig4_network.png            (from 06_network_analysis.R)
│   │   └── fig5_feedbacks.png          (from 09_cafi_condition_feedbacks.R)
...
│   ├── 06_network/          # Network analysis (1 figure: network_panels.png)
