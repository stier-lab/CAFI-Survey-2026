...
Occupant abundance in biogenic habitats -- corals, trees, kelps, oysters -- scales predictably with habitat size, yet whether scaling is proportional or sublinear determines per-capita density and the services occupants provide to their hosts. Whether sublinear scaling generates compositional turnover, and whether that turnover feeds back on habitat condition, have not been tested. We surveyed 114 *Pocillopora* coral colonies spanning three orders of magnitude in volume across three reef habitats in Mo'orea, French Polynesia, cataloging 3,989 coral-associated fishes and invertebrates (CAFI) from 243 taxa. Total CAFI abundance scaled sublinearly with colony volume (β = 0.52, 95% CI [0.44, 0.62]): larger corals harbor more occupants but at progressively lower per-capita densities, consistent with density dilution from a finite colonist pool. Colony volume explained 7.8% of community composition after accounting for reef site (db-RDA, p = 0.001), with species replacement accounting for 81% of beta diversity along the size gradient; shorter inter-colony distances independently enhanced richness (n = 61; p = 0.001), an effect that survived rarefaction. Species richness positively predicted coral physiological condition (standardized β = 0.36, raw p = 0.018, Hochberg-adjusted p = 0.036), consistent with biodiversity--ecosystem function theory, though richness and abundance are strongly correlated and adding coral morphotype absorbs the signal, preventing definitive causal attribution. Together, these results document a chain from habitat quantity through community assembly to habitat condition. Because density dilution leaves large colonies with proportionally fewer mutualists, this chain is relevant wherever habitat loss or climate stress restructures the occupant communities that feed back on habitat condition.
...
Increasing total CAFI on a colony therefore favors adding new species over additional conspecifics, consistent with the "species stacking" constraint [@Stier2012]. Our cross-sectional design cannot separate size from age; larger colonies may be older, giving colonization and competitive exclusion more time to shape the scaling regime. The companion experiment found proportional scaling during active recruitment ([Anonymous, in review]), consistent with community maturation -- rather than size per se -- driving the shift toward sublinear scaling in established communities. Our colonies were selected to span the size gradient rather than sampled randomly, which provides leverage for estimating β but may not represent the population-level size distribution.
...
### CAFI diversity and coral condition: a BEF test

Species richness positively predicted coral condition (p = 0.018), but the association is modest (adjusted R² = 0.04) and its mechanistic interpretation remains uncertain. The signal is entangled with abundance (shared explanatory power 70.8%). Rarefied richness showed no relationship (Fig. S8), but this null cannot adjudicate between the two interpretations: if diversity enhances condition partly through total occupancy -- more species means more defenders, more nutrient subsidizers, and fewer empty niches -- then rarefaction strips the mechanism along with the confound. The reduced sample (n = 47, 55% power) further limits inferential leverage.
...
Our observational design cannot resolve this ambiguity; richness and condition may both respond to unmeasured drivers without any direct effect. Adding coral morphotype as a covariate absorbed the richness signal (Table S13); however, replacing morphotype with genetic species identity (mtORF haplotype; @JohnstonCunningBurgess2022) did not absorb the signal (p = 0.010 vs 0.008 without haplotype; Table S15). Because field morphotype is a poor proxy for genetic species (33--94% concordance; Table S15), the morphotype covariate likely captures variation in branching architecture and interstitial space that determines which CAFI can colonize -- making morphotype either a mediator (part of the pathway through which habitat structure generates diversity) or a common cause that independently shapes both richness and condition. The observational design cannot distinguish these roles, but the haplotype result rules out genetic species identity as the driver. If morphotype is a mediator, conditioning on it masks the very pathway through which habitat structure generates diversity, and the absorption of the richness signal is expected rather than damning. Mediation analysis confirmed that the richness effect operates directly rather than through abundance (ACME p = 0.69; Table S12). The experimental literature provides mechanistic plausibility for complementarity -- defense [@Glynn1983; @Stier2012], nutrient subsidies [@Holbrook2008], bleaching buffering [@Chase2018], and synergistic defense [@McKeon2012] -- but plausibility is not evidence. A manipulative BEF experiment assembling controlled-richness communities on standardized colonies would directly test whether diversity enhances condition independent of abundance.
