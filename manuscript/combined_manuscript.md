...
We tested whether coral genetic species identity predicts CAFI community structure beyond colony size and site effects. Of 114 colonies, 101 were successfully genotyped (11 PCR failures, 2 missing samples). After excluding the single *P. acuta* and 2 colonies lacking volume measurements, 98 colonies representing four species remained for analysis.
